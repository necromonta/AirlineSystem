...
public class AccountManagerRepositoryIml {
    package io.github.fontysvenlo.ais.persistence;
...
class FlightRepositoryImpl implements FlightRepository {
    ...
    private final List<FlightData> flights = new ArrayList<>(Arrays.asList(
            new FlightData(1, "Budapest", "Eindhoven", LocalDate.of(2025, 1, 2), 230,accountManagerData),
            new FlightData(2, "Amsterdam", "Eindhoven", LocalDate.of(2004, 3, 2), 120,accountManagerData),
            new FlightData(3, "Eindhoven", "Budapest", LocalDate.of(2004, 3, 3), 230,accountManagerData),
            new FlightData(4, "Eindhoven", "Amsterdam", LocalDate.of(2004, 3, 4), 120,accountManagerData),
            new FlightData(5, "Budapest", "Amsterdam", LocalDate.of(2004, 3, 5), 250,accountManagerData)
    ));
    ...
    public FlightData add(FlightData FlightData) {
       ...
       // System.out.println(FlightData.toString());
        FlightData FlightDataWithId = new FlightData( flights.get(flights.size()-1).id()+1, FlightData.origin(), FlightData.destination(), FlightData.departureDate(),FlightData.distance(),FlightData.accountManagerData());
