...
class CustomerRepositoryImpl implements CustomerRepository {
    ...
    public CustomerData add(CustomerData customerData) {
        ...
        CustomerData customerDataWithId = new CustomerData( ++maxId, customerData.firstName(), customerData.lastName(), customerData.dateOfBirth(), customerData.phoneNumber(), customerData.paymentInfo());
